    ...
    <section class="food-search" style="background-image: url('images/doc.jpg');">
        <div class="container">
            ...
            <h2>Specialist on <a href="#" class="text-white">"<?php echo $category_title; ?>"</a></h2>
    ...
    <section class="food-menu">
        <div class="container">
            <h2 class="text-center">Book an Appointments</h2>
                    ...
                    while($row2=mysqli_fetch_assoc($res2))
                    {
                        ...
                        <div class="food-menu-box">
                            ...
                            <div class="food-menu-desc">
                                ...
                                <a href="<?php echo $SITEURL; ?>order.php?food_id=<?php echo $id; ?>" class="tn btn-primary">Make an Appointment</a>
                            </div>
                        </div>
